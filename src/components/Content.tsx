...
import { FeatureFormData, FeatureStatus, Theme, UserInfo } from '../types'
...
export const Content = () => {
  ...
  const { features, votes, addFeature, vote, loadVotes, loaded } = useWishFlow()
  ...
  const handleVote = async (featureId: string) => {
    await Promise.all([vote(featureId), loadVotes()])
  }

  const handleAddFeature = async (feature: FeatureFormData, userInfo: UserInfo) => {
    try {
      await addFeature(feature, userInfo)
